...
def createEpsilonGreedyPolicy(Q, epsilon, num_actions):
    ...
    and returns the probabilities for each action in the 
    form of a numpy array of length of the action space
...
def qLearning(env, num_episodes, discount_factor = 1.0, alpha = 0.6, epsilon = 0.1):
    ...
    while improving following an epsilon-greedy policy
    """
...
Q, stats = qLearning(env = env , num_episodes = 1000)
plotting.plot_episode_stats(stats)


# THIS BS CODE DOES NOT WORK CUZ OF LINE 94. two arguments are inputed apparently??
